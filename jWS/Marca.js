$(document).ready(function () {
    ...
    */
	...
	var FRM = new CRUD('4-MARCA', {C: '#CRUD_C', R: '.CRUD_R', U: '#EDITA', D: '#ELIMINA'}, INI_PAGE);	
            ...
            success: function (data) {
	        	...
	        	$.each(dta, function (index, value) {
	    			...
	    			if(index+1 > dta.length - 9 )
	    				$('#REG').append($(getRegFragment(value.id, value.Nombre)).fadeIn(0));
