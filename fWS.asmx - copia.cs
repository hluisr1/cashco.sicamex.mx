    ...
    public class fWS : System.Web.Services.WebService
    {
        ...
        public String s_CargaDetalle(String CompanyCode, int idCargaRuta)
        {
            ...
            while (r.Read())
            {
                ...
                L_CargaDetalle.Add(new CargaDetalle(r.GetInt32("idCargaRuta"), r.GetInt32("idProducto"), r.GetInt32("Cantidad_Propuesta"), r.GetInt32("Cantidad_Requerido"), r.GetInt32("Cantidad_Final"), r.GetString("Producto")));
